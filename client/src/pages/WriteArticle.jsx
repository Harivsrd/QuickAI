    ...
    const onSubmitHandler = async (e)=>{
        ...
        try{
            ...
            const {data} = await axios.post('/api/ai/generate-article', {prompt,
                length:selectedLength.length*10},{
    ...
    return(
        ...
        text-slate-700">
            ...
            border-gray-200">
                ...
                rounded-md border border-gray-300" placeholder="The future of artiificial intelligence is..." required />
                ...
                <div className="mt-3 flex gap-3 flex-wrap m:max-w-9/11">
                    {articleLength.map((item,index)=> (
                        ...
                        'bg-blue-50 text-blue-700' : 'text-gray-500 border-gray-300'}`}>{item.text}</span>
                    ))}
                </div>
                <br />
